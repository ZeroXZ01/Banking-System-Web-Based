...
<head>
  ...
  <title>Withdraw Funds | Secure Banking Portal</title>
  ...
  <div class="header-content">
    ...
    <div class="header-title">
      ...
      <div class="breadcrumb">
        <a href="${pageContext.request.contextPath}/index.jsp">Home</a> / Withdraw Funds
      </div>
    </div>
  </div>
</header>
...
<div class="container">
  <div class="form-header">
    ...
    <p class="subtitle">Securely withdraw money from your account</p>
  </div>

  <%-- Show success message if withdrawal was completed --%>
  <% if ("true".equals(request.getParameter("success"))) { %>
  <div class="message success">
    <i class="fas fa-check-circle"></i>
    <span>Your withdrawal was processed successfully. Redirecting to Home...</span>
  </div>
  <script>
    setTimeout(function() {
  ...
  <form action="<%= request.getContextPath() %>/accounts/withdraw" method="post">
    ...
    <div class="security-notice">
      ...
      <span>For your security, large withdrawals may require additional verification steps.</span>
    </div>
  </form>
