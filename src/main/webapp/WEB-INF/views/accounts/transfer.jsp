  ...
  <div class="header-content">
    ...
    <div class="header-title">
      ...
      <div class="breadcrumb">
        <a href="${pageContext.request.contextPath}/index.jsp">Home</a> / Transfer Funds
      </div>
    </div>
  </div>
</header>
...
<div class="container">
  <div class="form-header">
    ...
    <p class="subtitle">Move money between accounts securely</p>
  </div>

  <%-- Show success message if transfer was completed --%>
  <% if ("true".equals(request.getParameter("success"))) { %>
  <div class="message success">
    <i class="fas fa-check-circle"></i>
    <span>Your transfer was completed successfully. Redirecting to Home...</span>
  </div>
  <script>
    setTimeout(function() {
  ...
  <form action="<%= request.getContextPath() %>/accounts/transfer" method="post">
    <div class="form-group">
      <label for="fromAccountId">From Account</label>
      <input id="fromAccountId" type="text" name="fromAccountId" required>
    </div>
    ...
    <div class="form-group">
      ...
      <input id="toAccountId" type="text" name="toAccountId" required>
    </div>
